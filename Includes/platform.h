 ...
 * \date          12.03.20018
 *
 * $Id: platform.h 104 2018-05-01 14:07:11Z zajost $
 *
 *--------------------------------------------------------------------
 */
...
#if DEBUG_LED
#define LED_Blue_ON()                           (GPIOC_PCOR = (1<<2))   // PTC8
#define LED_Blue_OFF()                          (GPIOC_PSOR = (1<<2))
...
{
  PORTC_PCR8 = PORTC_PCR11 = PORTC_PCR2 = PORT_PCR_MUX(1);
  GPIOC_PDDR |= ((1<<8) | (1<<11) | (1<<2));
}
