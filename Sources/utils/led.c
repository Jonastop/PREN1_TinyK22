 ...
 * \date          20.04.20018
 *
 * $Id: led.c 96 2018-04-26 05:43:37Z zajost $
 *
 *--------------------------------------------------------------------
 */
#include "platform.h"
...
#define L_RED_FL FTM3_C5V
#define L_RED_FR FTM3_C2V
#define L_GREEN_FL FTM3_C4V
#define L_GREEN_FR FTM3_C7V
#define L_BLUE_FL FTM3_C6V
#define L_BLUE_FR FTM3_C3V
...
void ledInit(void)
{
  ...
  FTM3_C2SC = FTM_CnSC_MSx(2) | FTM_CnSC_ELSx(1);
  FTM3_C3SC = FTM_CnSC_MSx(2) | FTM_CnSC_ELSx(1);
  FTM3_C4SC = FTM_CnSC_MSx(2) | FTM_CnSC_ELSx(1);
  FTM3_C5SC = FTM_CnSC_MSx(2) | FTM_CnSC_ELSx(1);
  FTM3_C6SC = FTM_CnSC_MSx(2) | FTM_CnSC_ELSx(1);
  FTM3_C7SC = FTM_CnSC_MSx(2) | FTM_CnSC_ELSx(1);
}
